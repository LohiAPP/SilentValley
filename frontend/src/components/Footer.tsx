            ...
            <div className="container mx-auto px-6 max-w-6xl">
                <div className="flex flex-col md:flex-row justify-between gap-12 md:gap-8 mb-16">
                    ...
                    <div className="space-y-6 max-w-sm">
                        ...
                        <p className="text-nature-text/70 text-base leading-relaxed">
                    ...
                    <div className="md:px-8">
                        ...
                        <div className="flex flex-col space-y-3 text-base text-nature-text/80">
                    ...
                    <div>
                        ...
                        <div className="space-y-4">
                            ...
                            >
                                ...
                                <span className="text-base">+91 95020 01495</span>
                            </a>
                            ...
                            >
                                ...
                                <span className="text-base">PrakruthiSilentVally@gmail.com</span>
                            </a>
                ...
                <div className="pt-8 border-t border-nature-light/10 text-center">
                    <p className="text-nature-text/40 text-sm">
