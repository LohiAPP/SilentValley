...
export function AboutSection() {
    return (
        <section id="about" className="py-24 bg-nature-deep relative overflow-hidden scroll-mt-28">
            ...
            <div className="absolute top-0 right-0 w-1/3 h-full bg-linear-to- from-nature-dark/50 to-transparent pointer-events-none" />
            ...
            <div className="container mx-auto px-6 max-w-6xl relative z-10">
                <div className="grid md:grid-cols-2 gap-12 lg:gap-20 items-center">
                    ...
                    >
                        ...
                        <div className="space-y-8 text-nature-text/80 text-2xl leading-relaxed font-light tracking-wide">
                            <p>
                    ...
                    <motion.div
                        ...
                        className="relative"
                    >
                        <div className="relative aspect-[3/4] w-full max-w-lg lg:max-w-2xl mx-auto md:mx-0 rounded-[2rem] overflow-hidden shadow-2xl border border-nature-light/20 bg-nature-deep/5">
                            ...
                            <div className="absolute inset-0 bg-linear-to- from-nature-deep/40 to-transparent pointer-events-none" />
                        </div>
